package com.developer.orderservice.payment.command.application.controller;

import com.developer.orderservice.client.UserServiceClient;
import com.developer.orderservice.payment.command.application.dto.PaymentCallbackRequest;
import com.developer.orderservice.payment.command.application.dto.RequestPayDTO;
import com.developer.orderservice.payment.command.application.service.PaymentCommandService;
...
public class PaymentCommandController {
    ...
    public String payment(@PathVariable(name = "orderUid") String orderUid, Model model) {

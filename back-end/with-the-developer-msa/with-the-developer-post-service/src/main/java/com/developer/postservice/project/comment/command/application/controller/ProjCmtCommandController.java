package com.developer.postservice.project.comment.command.application.controller;
...
import com.developer.postservice.project.comment.command.application.service.ProjCmtCommandService;
...
public class ProjCmtCommandController {
    ...
    private Long getCurrentUserCode() {
        return userServiceClient.getCurrentUserCode();
    }

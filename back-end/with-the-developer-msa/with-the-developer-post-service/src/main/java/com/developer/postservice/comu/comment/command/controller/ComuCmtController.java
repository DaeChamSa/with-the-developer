package com.developer.postservice.comu.comment.command.controller;
...
import com.developer.postservice.comu.comment.command.service.ComuCmtService;
import com.developer.postservice.client.UserServiceClient;
import com.developer.postservice.comu.comment.command.service.ComuCmtService;
...
public class ComuCmtController {
    ...
    public ResponseEntity<Void> updateComuCmt(
        ...
        Long currentUserCode = getCurrentUserCode();
        comuCmtService.updateComuCnt(currentUserCode, comuCmtUpdateDTO);
    ...
    public ResponseEntity<Void> deleteComuCmt(
        ...
        Long currentUserCode = getCurrentUserCode();
        comuCmtService.deleteComuCmt(comuCmtCode, currentUserCode);
    ...
    private Long getCurrentUserCode() {
        return userServiceClient.getCurrentUserCode();  // SecurityUtil로부터 현재 로그인한 사용자 ID 가져오기
    }
}
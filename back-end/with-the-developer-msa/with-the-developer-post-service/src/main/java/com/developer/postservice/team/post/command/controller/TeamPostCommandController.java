package com.developer.postservice.team.post.command.controller;
...
public class TeamPostCommandController {
    ...
    public ResponseEntity<String> registTeamPost(
        ...
        teamPostDTO.setUserCode(userServiceClient.getCurrentUserCode());
    ...
    public ResponseEntity<String> deleteTeamPost(@PathVariable(name = "teamPostCode") Long teamPostCode) throws ParseException {
        ...
        // 로그인 중인 유저 코드 받아와 DTO에 삽입
        TeamPostDeleteDTO teamPostDTO = new TeamPostDeleteDTO(teamPostCode, userServiceClient.getCurrentUserCode());

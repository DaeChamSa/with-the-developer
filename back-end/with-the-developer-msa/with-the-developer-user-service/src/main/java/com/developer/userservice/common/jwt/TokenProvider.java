package com.developer.userservice.common.jwt;
...
import com.developer.userservice.user.command.application.dto.TokenSaveDTO;
...
public class TokenProvider {
    ...
    public TokenDTO generateTokenDto(Authentication authentication) {
        ...
        String refreshToken = Jwts.builder()
                ...
                .claim("userCode", userDetails.getUserCode())
    ...
    public boolean validateRefreshToken(String token) {
        try {
            ...
            log.info("잘못된 RefreshToken 서명입니다.");
        } catch (ExpiredJwtException e) {
            log.info("만료된 RefreshToken 토큰입니다.");
        } catch (UnsupportedJwtException e) {
            log.info("지원되지 않는 RefreshToken 토큰입니다.");
        } catch (IllegalArgumentException e) {
            log.info("RefreshToken 토큰이 잘못되었습니다.");
        }
        return false;
    }

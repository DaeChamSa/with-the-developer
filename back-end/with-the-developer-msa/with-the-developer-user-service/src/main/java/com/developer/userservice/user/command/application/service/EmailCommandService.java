...
import com.developer.userservice.user.command.application.dto.SendEmailDTO;
import com.developer.userservice.user.command.domain.aggregate.Email;
import com.developer.userservice.user.command.domain.repository.EmailRepository;

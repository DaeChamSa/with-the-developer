...
import com.developer.userservice.common.jwt.TokenProvider;
import com.developer.userservice.dto.ResponseBannedUserDTO;
import com.developer.userservice.user.command.application.dto.LoginUserDTO;
import com.developer.userservice.user.command.application.dto.PwResettingDTO;
import com.developer.userservice.user.command.application.dto.RegisterUserDTO;
import com.developer.userservice.user.command.application.dto.UpdateUserDTO;
import com.developer.userservice.user.command.domain.aggregate.*;
import com.developer.userservice.user.command.domain.repository.*;
import com.developer.userservice.user.security.CustomUserDetails;
...
public class UserCommandService {
    ...
    @Transactional
    public void updateUserStatus(Long userCode, UserStatus userStatus) {
        User user = userRepository.findByUserCode(userCode)
                .orElseThrow(() -> new CustomException(ErrorCode.NOT_FOUND_USER));
    ...
    @Transactional
    public void createBannedUser(Long userCode) {
        BannedUser bannedUser = new BannedUser(userCode);

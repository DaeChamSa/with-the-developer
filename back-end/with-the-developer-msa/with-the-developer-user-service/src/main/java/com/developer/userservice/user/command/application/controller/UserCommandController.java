package com.developer.userservice.user.command.application.controller;
...
import com.developer.userservice.common.jwt.ReissueTokenDTO;
import com.developer.userservice.common.jwt.TokenDTO;
import com.developer.userservice.common.success.SuccessCode;
import com.developer.userservice.user.command.application.dto.*;
import com.developer.userservice.user.command.application.service.EmailCommandService;
import com.developer.userservice.user.command.application.service.UserCommandService;
import com.developer.userservice.user.command.domain.aggregate.UserStatus;
import com.developer.userservice.user.security.*;
...
public class UserCommandController {
    ...
    @PostMapping("/{userCode}/status/{userStatus}")
    public ResponseEntity<Void> updateUserStatus(@PathVariable("userCode") Long userCode, @PathVariable("userStatus") UserStatus userStatus) {
        userService.updateUserStatus(userCode, userStatus);
        return ResponseEntity.ok().build();
    }

    @PostMapping("/{bannedUserCode}")
    public ResponseEntity<Void> createBannedUser(@PathVariable("bannedUserCode") Long bannedUserCode) {
        userService.createBannedUser(bannedUserCode);
        return ResponseEntity.ok().build();
    }
